...
class Calendar:
    ...
    def create_calendar(
        ...
        date_now = str(now_day.year) + check_date(str(now_day.month)) + check_date(str(now_day.day))
        for week in calendar.monthcalendar(year, month):
            row = list()
            for day in week:
                date_calendar = str(year) + check_date(str(month)) + check_date(str(day))
